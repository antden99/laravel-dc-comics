...
@section('content')
    <main>
        <div class="container">
            <h1>Apdate a Comic</h1>
            <form action="{{ route('comics.update',$comic) }}" method="post"> <!--qui praticamente richiamo la rotta comics.update e le passo l'oggetto comic da aggiornare-->
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputTitle" aria-describedby="descriptionHelp"
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="exampleInputDescription" aria-describedby="descriptionHelp" name="description">{{$comic->description}}</textarea>  <!--ricordati di inserire il testo tella text aria qui, e non come valore-->
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputThumb" aria-describedby="descriptionHelp"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputPrice" aria-describedby="descriptionHelp"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputSeries" aria-describedby="descriptionHelp"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputSaleDate" aria-describedby="descriptionHelp"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputType" aria-describedby="descriptionHelp"
